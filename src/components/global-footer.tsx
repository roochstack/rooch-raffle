        ...
        <div className="flex w-full items-center justify-between border-t border-gray-200 py-4 text-sm/6 text-gray-500 max-md:text-center">
          <span>
            ...
            <a
              ...
              className="ml-1 transition-all hover:text-primary hover:underline"
            >
              Rooch Network
            </a>
          </span>
          <div className="flex items-center">
            ...
            <a
              href="https://twitter.com/rooch_network"
              className="h-9 w-9 p-2 text-gray-400 transition-all hover:text-primary/80"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <a
              href="https://medium.com/rooch-network"
              className="h-9 w-9 p-2 text-gray-400 transition-all hover:text-primary/80"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
